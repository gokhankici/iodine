...
module yarvi( input  wire        clock
   ...
   // @annot{sanitize_glob(csr_mcpuid)}
   // @annot{sanitize_glob(csr_mimpid)}
   // @annot{sanitize_glob(csr_mtdeleg)}
   // @annot{sanitize_glob(csr_mbadaddr)}
...
`endif
   ...
   reg [31:0] ex_next_pc          = `INIT_PC;  // @annot{sanitize(ex_next_pc)}
...
// REWRITE -- multiple clocks are not used for this module in this benchmark
// end
